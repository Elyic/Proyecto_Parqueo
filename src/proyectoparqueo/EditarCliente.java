...
public class EditarCliente extends javax.swing.JFrame {
    ...
    public EditarCliente() {
        ...
        Icon icono1 = new ImageIcon(imagen1.getImage().getScaledInstance(jButton2.getHeight(), jButton2.getHeight(), Image.SCALE_DEFAULT));
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/edit-find.png"))); // NOI18N
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txtDPI, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Cliente cliente = new Cliente();
        if (txtDPI.getText().isEmpty() || txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Algun campo se encuentra vacio!");
        }else{
            if (cliente.ActualizarTablaCliente(txtDPI.getText(), txtNombre.getText(), txtApellido.getText())) {
